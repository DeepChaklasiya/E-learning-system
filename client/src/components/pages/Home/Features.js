      ...
      <Container>
        <Row className="d-flex align-items-center">
          <Col lg={6} md={12} style={{ textAlign: 'left' }}>
            ...
            <p>
              Our curated collection of top-rated business and technical courses
              gives companies, governments, and nonprofits the power to develop
              in-house expertise and satisfy employees’ hunger for learning and
              development.
            </p>
            <p className="mb-5">
